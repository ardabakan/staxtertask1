...
public class StaxterSamePid {

	final static Logger log = Logger.getLogger(StaxterSamePid.class);
	...
	public static void main(String[] args) {
		...
		if (args == null || args.length != 2) {
			...
			System.out.println("Please provide 2 ports to start 2 players, ex : \"java StaxterTest 9091 9092\"");
